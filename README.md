...
- **Smart Radar:** Displays tracked targets spotted nearby.
- **Wanted System:** Securely synchronizes marked targets and notes with mutually whitelisted players.
- **Bounty Network:** Broadcasts enemy locations through guild, party, or local channels.
- **Personal Database:** Tracks kills, deaths, and last-seen locations.
...
3. Ensure the folder is named `Vendetta`.
...
Both commands open the main database interface.
